...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.name && formData.email && formData.phone && formData.message) {
      setFormError(false);
      window.location.href = `mailto:mevipin17@gmail.com?&subject=${encodeURIComponent(
        formData.subject || "Enquiry"
      )}&body=Hi Vipin%0D%0A%0D%0AI'm ${encodeURIComponent(
        formData.name
              ...
              <div className="fields">
                ...
                >
                  ...
                  <div className="dizme_tm_button">
                    <a
                      id="send_message"
                      href={`mailto:mevipin17@gmail.com?&subject=${formData.subject}&body=Hi vipin%0D%0A%0D%0AI'm ${formData.name}%0D%0A%0D%0A${formData.message}`}
                    >
